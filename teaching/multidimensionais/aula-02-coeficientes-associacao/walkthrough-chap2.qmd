---
title: "Capítulo 2 de Borcard, Gillet & Legendre (2018) — exploração de dados ambientais com o pacote `vegan`."
subtitle: "Walkthrough do código — Aula 2: Coeficientes de associação"
format:
  html:
    toc: true
    toc-depth: 3
...
script `.R` original e os dados em [Aula 2](./).
:::
