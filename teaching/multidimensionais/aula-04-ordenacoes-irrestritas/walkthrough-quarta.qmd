---
title: "Walkthrough da aula prática — PCA, PCoA, nMDS, CA com vegan e ade4."
subtitle: "Walkthrough do código — Aula 4: Ordenações irrestritas: PCA, PCoA, nMDS e CA"
format:
  html:
    toc: true
    toc-depth: 3
...
script `.R` original e os dados em [Aula 4](./).
:::
