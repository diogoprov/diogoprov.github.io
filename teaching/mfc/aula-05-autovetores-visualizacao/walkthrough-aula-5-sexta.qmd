---
title: "Walkthrough — PVR, visualização avançada em árvores"
subtitle: "Walkthrough do código — Aula 5: Métodos baseados em autovetores e visualização"
format:
  html:
    toc: true
    toc-depth: 3
...
script `.R` original e os datasets em [Aula 5](./).
:::
