---
title: "Walkthrough completo da aula prática — R básico, importação de filogenias, manipulação de objetos `phylo`"
subtitle: "Walkthrough do código — Aula 1: Introdução e desenho de estudos comparativos"
format:
  html:
    toc: true
    toc-depth: 3
...
script `.R` original e os datasets em [Aula 1](./).
:::
