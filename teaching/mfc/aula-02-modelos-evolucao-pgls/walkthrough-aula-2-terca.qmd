---
title: "Walkthrough da aula prática — Movimento Browniano, OU básico, PGLS, estimativa de λ"
subtitle: "Walkthrough do código — Aula 2: Modelos de evolução de atributos contínuos e PGLS"
format:
  html:
    toc: true
    toc-depth: 3
...
script `.R` original e os datasets em [Aula 2](./).
:::
